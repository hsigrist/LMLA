...
\fullwidth{%
  ...
  \item[Instrucciones:] \textbf{Tiempo de duración de la Evaluación 80 minutos}. Lea atentamente las situaciones plantaedas, así como las intrucciones y conteste ofreciendo un desarrollo según corresponda. Evite borrones, use solamente lápiz grafito, no se permite el uso de calculadora ni celulares.
...
\question[3] $|z_4|-|z_3|=$
  ...
  \pagebreak
%----------------------------------------------------------------------------------------------------------------------------------------
\fullwidth{\noindent{\large \textbf{IV. Operatoria combinada en números complejos}}}

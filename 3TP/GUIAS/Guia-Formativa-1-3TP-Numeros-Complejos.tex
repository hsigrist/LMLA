...
\footer{}{}{}
\def\mytitle{Guia Formativa 1 3TP Números Complejos}
\def\mykeywords{imaginarios, potencias imaginarios}
\def\mysubject{Números imaginarios}
...
\fullwidth{\noindent{\large \textbf{II. Calcula el valor de las siguientes potencias de $i$, reduce al máximo tu resultado.}}}
